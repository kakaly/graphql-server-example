    ...
    addTrace({ trace, queryHash, documentAST, operationName, queryString, schemaHash, }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!(schemaHash in this.reports)) {
                this.reportHeaders[schemaHash] = new apollo_engine_reporting_protobuf_1.ReportHeader(Object.assign({}, serviceHeaderDefaults, { schemaHash, schemaTag: this.options.schemaTag || process.env.ENGINE_SCHEMA_TAG || '' }));
    ...
    sendReport(schemaHash) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (response.status < 200 || response.status >= 300) {
                throw new Error(`Error sending report to Apollo Engine servers (HTTP status ${response.status}): ${yield response.text()}`);
            }
            if (this.options.debugPrintReports) {
